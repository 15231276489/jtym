...
UIMIX.fullview = {
    ...
    relocate: function() {
        ...
        if (UIMIX.fullview.data.fix_width > 0 && UIMIX.fullview.data.fix_height > 0) {
            ...
            w = $(window).width(); //UIMIX.fullview.data.fix_width;
            h = $(window).width()*3/4 //UIMIX.fullview.data.fix_height//4:3图片
        } else {
    ...
    refresh: function() {
        if (UIMIX.fullview.data.ticker === 0) {
            UIMIX.fullview.data.ticker = setInterval(UIMIX.fullview.render, Math.round(1000 / 20))
        }
    },
    ...
    resetting:function(){
        ...
        UIMIX.fullview.data.totalFrames=180;
